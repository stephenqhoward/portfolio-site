...
const PortfolioItemImage: FC<portfolioitemimage> = ({ img, url, position }) => {
  ...
  let divClassNames = "sm:w-[100%] lg:w-[40%] flex items-center sm:justify-center lg:justify-end lg:pr-4"
  
  if (position === "left") {
    imgClassNames = "lg:drop-shadow-[-8px_8px_8px_rgba(0,0,0,0.5)] lg:-skew-y-3 rounded-md"
    divClassNames = "sm:w-[100%] lg:w-[40%] flex items-center sm:justify-center lg:justify-start lg:pl-4"
  }
