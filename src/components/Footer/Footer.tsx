  ...
  <>
    <div className={styles["footer"]}>
      <ul className="flex flex-row items-center justify-center my-4 md:my-8 space-x-8">
        <li className="bg-deep-blue flex items-center rounded-full duration-500 motion-safe:hover:scale-105">
        ...
        <li className="bg-deep-blue rounded-full duration-500 motion-safe:hover:scale-105">
