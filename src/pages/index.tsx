  ...
  return (
    <>
      ...
      <main className="flex min-h-screen flex-col items-center justify-center bg-gradient-to-b from-[#15222c] to-[#022b6d]">
        ...
        <section className="container min-h-[40vh] flex flex-row" id="about">
          <div className="pr-36">
            <h2>About Me</h2>
            <ul>
        ...
        <section className="container min-h-[80vh]" id="portfolio">
          <h2>Portfolio</h2>
          <div>
        ...
        <section className="container min-h-[40vh]" id="social">
          <h2>Social</h2>
          <ul>
