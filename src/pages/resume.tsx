  ...
  return (
    <>
      ...
      <main className="flex min-h-screen flex-col items-center bg-gradient-to-b from-[#1D3557] to-[#457B9d]">
        <Link href="/">
          <div className="fixed left-8 top-8 flex h-16 w-32 justify-center rounded-xl bg-cream duration-500 hover:cursor-pointer hover:bg-light-blue motion-safe:hover:scale-105">
        ...
        >
          <div className="fixed top-32 left-8 flex h-16 w-32 justify-center rounded-xl bg-light-blue duration-500 hover:cursor-pointer hover:bg-cream motion-safe:hover:scale-105">
